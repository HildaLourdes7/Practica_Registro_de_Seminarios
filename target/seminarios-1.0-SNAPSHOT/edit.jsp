            ...
            <table border="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" id="curso3" name="curso" value="Simulacion con Arena" <%= (reg.getSeminarios() != null && reg.getSeminarios().contains("Simulacion con Acer ")) ? "checked" : ""%>>
                        <label for="curso3">Simulación con Arena </label><br>
                        ...
                        <label for="curso4">Robótica Educativa </label><br>
